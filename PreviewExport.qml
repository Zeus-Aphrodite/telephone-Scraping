                            ...
                            footer: Rectangle {
                                ...
                                Row {
                                    ...
                                    CustomButton {
                                        text: "Export"
                                        onClicked: {
                                            Backend.save_fetched(root.path, root.extension, root.headWidth)
                                            root.close()
                                        }
                                    }
                                }
